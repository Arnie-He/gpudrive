...
from utils import make_agent, get_model_parameters, load_config, make_concatenated_obs
from utils import ExpertDataset, Discriminator, train_discriminator, load_human_expert_data
...
def train(args, vecenv, expert_dataset):
    """
...
def run(
    ...
    *,
    ...
    rl_weight_decay: Annotated[Optional[float], typer.Option(help="Weight decay for training")] = None,
    ...
    train_config = {
        ...
        "gamma": gamma,
        "vf_coef": vf_coef,
        "rl_weight_decay": rl_weight_decay,
    ...
    train(config, vecenv, expert_dataset)   
